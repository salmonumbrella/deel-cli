...
LDFLAGS := -ldflags "-X github.com/salmonumbrella/deel-cli/internal/cmd.Version=$(VERSION) -X github.com/salmonumbrella/deel-cli/internal/cmd.Commit=$(COMMIT) -X github.com/salmonumbrella/deel-cli/internal/cmd.BuildDate=$(BUILD_DATE)"

build:
	go build $(LDFLAGS) -o ./bin/deel ./cmd/deel
